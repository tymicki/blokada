...
class TunnelMain {
    ...
    fun setAdblocking(adblocking: Boolean) = async(context) {
        ...
        currentTunnel = currentTunnel.copy(adblocking = adblocking)
        tunnelConfig = tunnelConfig.copy(adblocking = adblocking)
    ...
    fun setTunnelConfiguration(tunnelConfig: TunnelConfig) = async(context) {
        ...
        if (this@TunnelMain.tunnelConfig == tunnelConfig) {
            ...
            currentTunnel = currentTunnel.copy(adblocking = tunnelConfig.adblocking)
